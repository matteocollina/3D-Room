<script lang="ts">
	...
	import { applyTransformOfSelected, deleteSelectedObject, editorState, roomState, rotateLeft, rotateObject, rotateRight, saveRoomToLocalStorage } from "$lib/state.svelte";
	import ColorPickerPopover from "./ColorPickerPopover.svelte";

	import * as Popover from "$lib/components/base/popover";
	import { hex_to_rgb, okhsv_to_rgb, rgb_to_hex, rgb_to_okhsv } from "$lib/components/extra/color-picker/color";

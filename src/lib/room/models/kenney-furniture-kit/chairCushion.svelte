...
Command: npx @threlte/gltf@3.0.0 static/models/kenney-furniture-kit/chairCushion.glb -t -s
-->
...
<script lang="ts">
	...
	type GLTFResult = {
		nodes: {
			Mesh_chairCushion: THREE.Mesh;
			Mesh_chairCushion_1: THREE.Mesh;
		};
		materials: {
	...
	const gltf = useGltf<GLTFResult>(base + '/models/kenney-furniture-kit/chairCushion.glb');
</script>
...
<T.Group bind:ref dispose={false} {...props}>
	...
	{:then gltf}
		<T.Mesh
			castShadow
			receiveShadow
			geometry={gltf.nodes.Mesh_chairCushion.geometry}
		...
		<T.Mesh
			castShadow
			receiveShadow
			geometry={gltf.nodes.Mesh_chairCushion_1.geometry}

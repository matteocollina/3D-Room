...
Command: npx @threlte/gltf@3.0.0 -t -s -u models/kaykit-furniture-kit/pictureframe_medium.glb -r /room/
-->
...
<script lang="ts">
	...
	const gltf = suspend(
		useGltf<GLTFResult>(base + '/models/kaykit-furniture-kit/pictureframe_medium.glb')
	);
</script>
...
<T.Group bind:ref dispose={false} {...props}>
	...
	{:then gltf}
		<T.Group>
			...
			>
			<T.Mesh castShadow receiveShadow geometry={gltf.nodes.Cube015_1.geometry}

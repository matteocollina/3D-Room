...
<script lang="ts">
  ...
  const gltf = suspend(useGltf<GLTFResult>(base + '/models/kaykit-furniture-kit/pictureframe_standing_b.glb'))
</script>
  ...
  {:then gltf}
    <T.Mesh
      ...
      geometry={gltf.nodes.Cube023_1.geometry}
       ><RoomObjectMaterial image={image} colors={colors} opacity={opacity} /></T.Mesh>  {:catch err}

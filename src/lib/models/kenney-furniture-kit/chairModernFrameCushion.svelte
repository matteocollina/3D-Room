...
Command: npx @threlte/gltf@3.0.0 static/models/kenney-furniture-kit/chairModernFrameCushion.glb -t -s
-->
...
<script lang="ts">
  ...
  type GLTFResult = {
    nodes: {
      Mesh_chairModernFrameCushion: THREE.Mesh
      Mesh_chairModernFrameCushion_1: THREE.Mesh
    }
    materials: {
  ...
  const gltf = useGltf<GLTFResult>(base + '/models/kenney-furniture-kit/chairModernFrameCushion.glb');
</script>
...
>
  ...
  {:then gltf}
    <T.Mesh
      castShadow
      receiveShadow
      geometry={gltf.nodes.Mesh_chairModernFrameCushion.geometry}
    ...
    <T.Mesh
      castShadow
      receiveShadow
      geometry={gltf.nodes.Mesh_chairModernFrameCushion_1.geometry}

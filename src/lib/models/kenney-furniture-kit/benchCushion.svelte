...
Command: npx @threlte/gltf@3.0.0 static/models/benchCushion.glb -t -s
-->
...
<script lang="ts">
	...
	type GLTFResult = {
		nodes: {
			Mesh_benchCushion: THREE.Mesh;
			Mesh_benchCushion_1: THREE.Mesh;
		};
		materials: {
	...
	const gltf = useGltf<GLTFResult>(base + '/models/kenney-furniture-kit/benchCushion.glb');
</script>
...
<T.Group bind:ref dispose={false} {...props}>
	...
	{:then gltf}
		<T.Mesh
			castShadow
			receiveShadow
			geometry={gltf.nodes.Mesh_benchCushion.geometry}
		...
		<T.Mesh
			castShadow
			receiveShadow
			geometry={gltf.nodes.Mesh_benchCushion_1.geometry}
